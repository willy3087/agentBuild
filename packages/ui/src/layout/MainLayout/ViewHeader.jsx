...
const ViewHeader = ({
    ...
    const defaultSearchPlaceholder = searchPlaceholder || t('common.search.placeholder')
        ...
        <Box sx={{ flexGrow: 1, py: 1.25, width: '100%' }}>
            ...
            >
                <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'row' }}>
                    {isBackButton && (
                        <StyledFab sx={{ mr: 3 }} size='small' color='secondary' aria-label='back' title={t('common.buttons.back')} onClick={onBack}>
                            <IconArrowLeft />
                        </StyledFab>
                    )}
                    ...
                    {isEditButton && (
                        <IconButton sx={{ ml: 3 }} color='secondary' title={t('common.buttons.edit')} onClick={onEdit}>
                            <IconEdit />
                        </IconButton>
                    )}
                </Box>
