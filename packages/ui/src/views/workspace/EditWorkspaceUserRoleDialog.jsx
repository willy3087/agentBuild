...
const EditWorkspaceUserRoleDialog = ({ show, dialogProps, onCancel, onConfirm }) => {
    ...
    const updateUser = async () => {
        try {
            ...
            if (saveResp.data) {
                enqueueSnackbar({
                    message: t('workspace.users.dialog.editRole.notifications.updated'),
                    options: {
            ...
            enqueueSnackbar({
                message: t('workspace.users.dialog.editRole.notifications.updateFailed', {
        ...
        >
            <DialogTitle sx={{ fontSize: '1rem' }} id='alert-dialog-title'>
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    {t('workspace.users.dialog.editRole.title', { userEmail: userEmail || '', userName: user.name ? ` (${user.name})` : '' })}
                </div>
            </DialogTitle>
            <DialogContent>
                <Box sx={{ p: 1 }}>
                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                        <Typography>
                            {t('workspace.users.dialog.editRole.fields.role.label')}<span style={{ color: 'red' }}>&nbsp;*</span>
                        </Typography>
                    ...
                    <Autocomplete
                        ...
                        renderInput={(params) => <TextField {...params} variant='outlined' placeholder={t('workspace.users.dialog.editRole.fields.role.placeholder')} />}
                        value={selectedRole}
